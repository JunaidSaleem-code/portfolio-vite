...
const Approach = ({ phases }) => {
  const items = phases && phases.length ? phases : DEFAULT_PHASES;
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4 ">
        {items.map((phase) => (
          <Card
            ...
            icon={<AceternityIcon order={phase.phaseLabel} />}
          >
            <CanvasRevealEffect
              animationSpeed={phase.animationSpeed ?? 3}
              containerClassName={phase.backgroundClass}
              colors={phase.colors}
